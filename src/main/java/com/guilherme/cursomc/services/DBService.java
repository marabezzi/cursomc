...
public class DBService {
	...
	Categoria cat4 = new Categoria(null, "Cama mesa banho");
	...
	Cliente cli1 = new Cliente(null, "Maria Silva", "dev.atomsistemas@gmail.com", "62583947281", TipoCliente.PESSOAFISICA, pe.encode("123"));
	cli1.getTelefones().addAll(Arrays.asList("27736335", "99886512"));
	
	
	
	Cliente cli2 = new Cliente(null, "Ana Costa", "marabezzi@yahoo.com.br", "38753855604", TipoCliente.PESSOAFISICA, pe.encode("123"));
	cli2.getTelefones().addAll(Arrays.asList("99998233", "81265489"));
	cli2.addPerfil(Perfil.ADMIN);
	
	
	Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
	Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
	Endereco e3 = new Endereco(null, "Avenida Floriano", "106", "Sala 1", "Centro", "2887716", cli2, c2);
